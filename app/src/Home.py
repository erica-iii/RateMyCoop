...
if st.button("Act as Ellie Ryder, Student", 
            type = 'primary', 
...
if st.button('Act as Clark Kent, System Administrator', 
            type = 'primary', 
            use_container_width=True):
    st.session_state['authenticated'] = True
...
if st.button('ex', type = 'primary', use_container_width=True):
    st.session_state['authenticated'] = True
